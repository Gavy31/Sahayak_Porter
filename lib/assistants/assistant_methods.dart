import 'package:sahayak_kooli/assistants/request_assistant.dart';
import 'package:sahayak_kooli/global/global.dart';
import 'package:sahayak_kooli/global/map_key.dart';
import 'package:sahayak_kooli/infoHandler/app_info.dart';
import 'package:sahayak_kooli/models/direction_details_info.dart';
import 'package:sahayak_kooli/models/directions.dart';
import 'package:sahayak_kooli/models/user_model.dart';
...
class AssistantMethods
{
  ...
  static void readTripsKeysForOnlinePorter(context)
  {
    FirebaseDatabase.instance.ref()
        .child("All Ride Requests")
        .orderByChild("porterId")
  ...
  //readPorterEarnings
  static void readPorterEarnings(context)
  {
    FirebaseDatabase.instance.ref()
        .child("porters")
        ...
        .then((snap)
    {
      if(snap.snapshot.value != null)
      {
        String porterEarnings = snap.snapshot.value.toString();
        Provider.of<AppInfo>(context, listen: false).updatePorterTotalEarnings(porterEarnings);
      }
    });

    readTripsKeysForOnlinePorter(context);
  }

  static void readPorterRatings(context)
  {
    FirebaseDatabase.instance.ref()
        .child("porters")
        .child(fAuth.currentUser!.uid)
        ...
        .then((snap)
    {
      if(snap.snapshot.value != null)
      {
        String porterRatings = snap.snapshot.value.toString();

        Provider.of<AppInfo>(context, listen: false).updatePorterAverageRatings(porterRatings);
      }
    });
  }
}